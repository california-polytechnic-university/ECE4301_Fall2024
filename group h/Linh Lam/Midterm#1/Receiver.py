...
total_execution_time = 0  # Initialize for overall execution time
...
try:
    ...
    avg_execution_time = (total_receive_time + total_decryption_time) / frame_counter if frame_counter else 0  # Total execution time
    ...
    print(f"Average Total Execution Time: {avg_execution_time:.6f} seconds")  # Display average total execution time
